...
from rsa.utils.serialization_utils import convert_json
...
class Logger:
    ...
    def __init__(self, output_dir, output_fname='progress.csv', exp_name=None):
        ...
        #     print('Log dir %s already exists! Would you like to overwrite it?' % self.output_dir)
        #     # TODO maybe clean up the language here
        #     resp = 'piss shit cum'
        #     while resp not in ('yes', 'no', 'y', 'n'):
        #         if resp != 'piss shit cum':
        #             print('Invalid input!')
        #         resp = input(' yes/y/no/n > ')
        #         resp = resp.lower()
        #
        #     if resp in ('no', 'n'):
        #         assert False, "Run again with new exper name or allow overwrite"
        #     print("Overwriting")
        # else:
        #     os.makedirs(self.output_dir)
